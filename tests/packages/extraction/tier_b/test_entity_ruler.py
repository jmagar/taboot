...
class TestSpacyEntityRuler:
    ...
    @pytest.fixture
    def entity_ruler(self) -> None:
        """Create entity ruler instance."""
        return SpacyEntityRuler(model="en_core_web_sm")

    def test_extract_service_entities(self, entity_ruler) -> None:
    ...
    def test_extract_host_entities(self, entity_ruler) -> None:
    ...
    def test_extract_ip_entities(self, entity_ruler) -> None:
    ...
    def test_extract_port_entities(self, entity_ruler) -> None:
    ...
    def test_extract_mixed_entities(self, entity_ruler) -> None:
        ...
        service_mentions = [e for e in entities if "service" in e["text"].lower()]
        assert "SERVICE" in labels or service_mentions
        assert "IP" in labels
        assert "PORT" in labels

    def test_empty_text_returns_empty_list(self, entity_ruler) -> None:
        """Test that empty text returns empty list."""
        entities = entity_ruler.extract_entities("")
        assert entities == []

    def test_text_without_entities(self, entity_ruler) -> None:
