...
@pytest.mark.unit
def test_graph_traversal_builds_cypher_query():
...
@pytest.mark.slow
def test_graph_traversal_with_real_neo4j(neo4j_client):
    ...
    results = traversal.traverse_from_entities(
        entity_names=["api-service"],
        max_hops=2
    )
...
@pytest.mark.unit
def test_graph_traversal_prioritizes_relationships():
