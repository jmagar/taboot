...
@pytest.mark.unit
def test_vector_search_builds_metadata_filter():
    ...
    # Test source filter
    filter_dict = search.build_metadata_filter(
...
@pytest.mark.slow
def test_vector_search_with_real_qdrant(qdrant_client):
